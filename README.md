...
- **Профили проекта** — логический проект из нескольких репозиториев GitLab; при экспорте выбирается конкретный профиль или **все профили**
...
7. Задайте **projectProfiles** в настройках → запустите **GitLab Issues: Export project overview** → выберите нужный профиль или вариант **Все профили**
